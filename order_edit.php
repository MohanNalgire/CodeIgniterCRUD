...
<?php echo form_open('orderCtrl/update'); ?>
...
<div class="row" >
	...
	<div class="col-6 form-group" >
		...
		<input type="text" class="form-control" id="" name="order_status_id" placeholder="Default User Id" value="<?= $data[0]->order_status_id; ?>"  />
...
<div class="row" >
	<div class="col-6 form-group" >
		...
		<select class="form-control" id="" name="chemist_type_id" placeholder="Chemist Type"  >
	...
	<div class="col-6 form-group" >
		...
		<select class="form-control" id="" name="invoice_id" placeholder="Invoice Id"  >
